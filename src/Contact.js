...
const Contact = () => {
    return (
        <div>
        <Header />
        <p className="h-100">This website is Made By Ankur yadav </p>
        
        <div className="container-sm card contact-box d-flex flex-row p-5 justify-content-between">   
            ...
            <a className="linkdien" href="www.linkedin.com/in/ankur-yadav-905b77217">
